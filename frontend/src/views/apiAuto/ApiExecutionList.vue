...
<style scoped>
.page-wrap-single { padding: 20px; background: #f0f2f5; min-height: 100%; }
.content-card { background: #fff; border-radius: 10px; padding: 20px; box-shadow: 0 1px 4px rgba(0,0,0,0.06); min-height: calc(100% - 0px); }
